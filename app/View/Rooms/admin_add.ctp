      ...
      <div class="col-md-6">
        <form id="saveRoom" action="/admin/rooms/add" method="POST">
          <div class="form-group">
            ...
            <input placeholder="Ejemplo: Habitacion deluxe" type="text" name="name" class="form-control">
          </div><!-- /.form-group -->
          <div class="form-group">
            <label>Descripción</label>
            <textarea placeholder="Ejemplo: Vista al mar, con 2 recamaras, sala comedor, etc" rows="3" class="form-control" name="description"></textarea>
          </div><!-- /.form-group -->
